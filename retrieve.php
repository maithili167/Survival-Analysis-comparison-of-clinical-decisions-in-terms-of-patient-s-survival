...
if ($arg == "data"){
	...
	for ($i=1; $i <= $max; $i++) { 
		# code...
		echo "<tr><td>".$i."</td><td>".$dataset[0][$i]."</td><td>".$dataset[1][$i]."</td></tr>";
	}
	echo "</tbody></table>";
	...
	for ($i=1; $i <= $max; $i++) { 
		# code...
		echo "<tr><td>".$i."</td><td>".$agedataset[0][$i]."</td><td>".$agedataset[1][$i]."</td><td>".$agedataset[2][$i]."</td><td>".$agedataset[3][$i]."</td><td>".$agedataset[4][$i]."</td><td>".$agedataset[5][$i]."</td><td>".$agedataset[6][$i]."</td><td>".$agedataset[7][$i]."</td><td>".$agedataset[8][$i]."</td></tr>";
	}
	echo "</tbody></table>";
}
